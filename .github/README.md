...
[`@aws-sdk/client-cloudcontrol`](https://www.npmjs.com/package/@aws-sdk/client-cloudcontrol/v/3.245.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudcontrol@3.245.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Nveb6as5l2BMc3ZAAxq+ogMP04XguJdRONlsSHdAFKP/kp52rDNyQiz+mceZug/P
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cloudcontrol": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudcontrol@3.245.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudcontrol@3.245.0/index.min.mjs": "sha384-Nveb6as5l2BMc3ZAAxq+ogMP04XguJdRONlsSHdAFKP/kp52rDNyQiz+mceZug/P"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cloudcontrol/blob/refs/tags/3.245.0/LICENSE
```
